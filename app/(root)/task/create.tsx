      ...
      <View className="flex-1 px-6 pt-4">
        ...
        <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
          ...
          <View className="flex-row justify-between mb-6">
            <TouchableOpacity
              className={`flex-row items-center bg-white p-3 rounded-xl flex-1 mr-2 border border-gray-200`}
              onPress={() => console.log("Open Date Picker")}
            >
              <Ionicons name="calendar" size={18} color="#6B7280" />
              <Text className={`text-base ml-2 text-textSecondary`}>
                Due Date
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              className={`flex-row items-center bg-white p-3 rounded-xl flex-1 ml-2 border border-gray-200`}
          ...
          <TouchableOpacity
            className={`flex-row items-center justify-center bg-white p-4 rounded-xl border-2 border-dashed border-gray-300 mb-6 ${taskImageUri ? "h-32" : "h-44"}`}
